        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AnalyseCompétence>(entity =>
            {
                ...
                entity.HasOne(d => d.AdresseCourrielNavigation)
                    ...
                    .HasConstraintName("FK__AnalyseCo__Adres__656C112C");

                entity.HasOne(d => d.CodeCompetenceNavigation)
                    .WithMany(p => p.AnalyseCompétence)
                    .HasForeignKey(d => d.CodeCompetence)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__AnalyseCo__CodeC__66603565");

                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.AnalyseCompétence)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__AnalyseCo__NoPro__6754599E");
            });
            ...
            modelBuilder.Entity<AnalyseElementsCompetence>(entity =>
            {
                ...
                entity.HasOne(d => d.AdresseCourrielNavigation)
                    ...
                    .HasForeignKey(d => d.AdresseCourriel)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__AnalyseEl__Adres__03F0984C");

                entity.HasOne(d => d.ElementCompétenceNavigation)
                    .WithMany(p => p.AnalyseElementsCompetence)
                    .HasForeignKey(d => d.ElementCompétence)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__AnalyseEl__Eleme__02FC7413");

                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.AnalyseElementsCompetence)
                    .HasForeignKey(d => d.NoProgramme)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__AnalyseEl__NoPro__02084FDA");
            });
            ...
            modelBuilder.Entity<Commentaires>(entity =>
            {
                ...
                entity.HasOne(d => d.AdresseCourrielNavigation)
                    ...
                    .HasForeignKey(d => d.AdresseCourriel)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Commentai__Adres__5CD6CB2B");

                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.Commentaires)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Commentai__NoPro__5DCAEF64");
            });
            ...
            modelBuilder.Entity<Competences>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    ...
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Competenc__NoPro__5BE2A6F2");

                entity.HasOne(d => d.NomFamilleNavigation)
                    .WithMany(p => p.Competences)
                    .HasForeignKey(d => d.NomFamille)
                    .HasConstraintName("FK__Competenc__NomFa__5AEE82B9");

                entity.HasOne(d => d.NomSequenceNavigation)
                    .WithMany(p => p.Competences)
                    .HasForeignKey(d => d.NomSequence)
                    .HasConstraintName("FK__Competenc__NomSe__7E37BEF6");
            });
            ...
            modelBuilder.Entity<CompetencesElementCompetence>(entity =>
            {
                ...
                entity.HasOne(d => d.CodeCompetenceNavigation)
                    ...
                    .HasForeignKey(d => d.CodeCompetence)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Competenc__CodeC__6A30C649");

                entity.HasOne(d => d.ElementCompétenceNavigation)
                    .WithMany(p => p.CompetencesElementCompetence)
                    .HasForeignKey(d => d.ElementCompétence)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Competenc__Eleme__6B24EA82");

                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.CompetencesElementCompetence)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Competenc__NoPro__6C190EBB");
            });
            ...
            modelBuilder.Entity<Cours>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.Cours)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Cours__NoProgram__5EBF139D");

                entity.HasOne(d => d.NomGroupeNavigation)
                    .WithMany(p => p.Cours)
                    .HasForeignKey(d => d.NomGroupe)
                    .HasConstraintName("FK__Cours__NomGroupe__7F2BE32F");

                entity.HasOne(d => d.NomSessionNavigation)
                    .WithMany(p => p.Cours)
                    .HasForeignKey(d => d.NomSession)
                    .HasConstraintName("FK__Cours__NomSessio__5FB337D6");
            });
            ...
            modelBuilder.Entity<CoursCompetences>(entity =>
            {
                ...
                entity.HasOne(d => d.CodeCompetenceNavigation)
                    ...
                    .HasForeignKey(d => d.CodeCompetence)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CoursComp__CodeC__6383C8BA");

                entity.HasOne(d => d.NoCoursNavigation)
                    .WithMany(p => p.CoursCompetences)
                    .HasForeignKey(d => d.NoCours)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__CoursComp__NoCou__628FA481");

                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.CoursCompetences)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__CoursComp__NoPro__6477ECF3");
            });
            ...
            modelBuilder.Entity<Elementcompetence>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    ...
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Elementco__NoPro__619B8048");
            });
            ...
            modelBuilder.Entity<Famillecompetence>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    ...
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Familleco__NoPro__59FA5E80");
            });
            ...
            modelBuilder.Entity<Groupe>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.Groupe)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Groupe__NoProgra__59063A47");
            });
            ...
            modelBuilder.Entity<GroupeCompetence>(entity =>
            {
                ...
                entity.HasOne(d => d.CodeCompetenceNavigation)
                    ...
                    .HasForeignKey(d => d.CodeCompetence)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__GroupeCom__CodeC__08B54D69");

                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.GroupeCompetence)
                    .HasForeignKey(d => d.NoProgramme)
                    .OnDelete(DeleteBehavior.Cascade)
                    .HasConstraintName("FK__GroupeCom__NoPro__06CD04F7");

                entity.HasOne(d => d.NomGroupeNavigation)
                    .WithMany(p => p.GroupeCompetence)
                    .HasForeignKey(d => d.NomGroupe)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__GroupeCom__NomGr__07C12930");

                entity.HasOne(d => d.NomSessionNavigation)
                    .WithMany(p => p.GroupeCompetence)
                    .HasForeignKey(d => d.NomSession)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__GroupeCom__NomSe__09A971A2");
            });
            ...
            modelBuilder.Entity<Membresdesactualisations>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.Membresdesactualisations)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Membresde__NoPro__7A672E12");
            ...
            modelBuilder.Entity<Prealables>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.Prealables)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Prealable__NoPro__6EF57B66");
            });
            ...
            modelBuilder.Entity<RepartirHeureCompetence>(entity =>
            {
                ...
                entity.HasOne(d => d.CodeCompetenceNavigation)
                    ...
                    .HasForeignKey(d => d.CodeCompetence)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__RepartirH__CodeC__68487DD7");

                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.RepartirHeureCompetence)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__RepartirH__NoPro__693CA210");
            });
            ...
            modelBuilder.Entity<RepartitionHeureCours>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.RepartitionHeureCours)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Repartiti__NoPro__76969D2E");
            });
            ...
            modelBuilder.Entity<RepartitionHeuresession>(entity =>
            {
                ...
                entity.HasOne(d => d.AdresseCourrielNavigation)
                    ...
                    .HasForeignKey(d => d.AdresseCourriel)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Repartiti__Adres__6FE99F9F");

                entity.HasOne(d => d.CodeCompetenceNavigation)
                    .WithMany(p => p.RepartitionHeuresession)
                    .HasForeignKey(d => d.CodeCompetence)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Repartiti__CodeC__70DDC3D8");

                entity.HasOne(d => d.NoProgrammeNavigation)
                    .WithMany(p => p.RepartitionHeuresession)
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Repartiti__NoPro__72C60C4A");

                entity.HasOne(d => d.NomSessionNavigation)
                    .WithMany(p => p.RepartitionHeuresession)
                    .HasForeignKey(d => d.NomSession)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Repartiti__NomSe__71D1E811");
            });
            ...
            modelBuilder.Entity<Sequences>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    ...
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Sequences__NoPro__7D439ABD");
            });
            ...
            modelBuilder.Entity<Session>(entity =>
            {
                ...
                entity.HasOne(d => d.NoProgrammeNavigation)
                    ...
                    .HasForeignKey(d => d.NoProgramme)
                    .HasConstraintName("FK__Session__NoProgr__5812160E");
            });
